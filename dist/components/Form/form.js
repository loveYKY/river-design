...
export var Form = React.forwardRef(function (props, ref) {
    ...
    //将方法挂载到自定义组件实例
    useImperativeHandle(ref, function () { return (__assign({ validate: validate }, restProps)); });
    var passContext = {
        dispatch: dispatch,
        fields: fields,
    ...
    var handleSubmit = function (e) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), values = _a.values, errors = _a.errors, isValid = _a.isValid;
                    //校验成功
                    if (isValid) {
                        if (onFinished) {
                            onFinished(values);
    ...
    return (React.createElement("form", { name: name, className: "river-form", onSubmit: handleSubmit },
        React.createElement(FormContext.Provider, { value: passContext }, children)));
});
Form.defaultProps = {
    name: 'river-form',
};
